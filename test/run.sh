...
scrub(){ rm -rf sites/acme sites/tmp1 sites/tmp2 sites/tmp3 sites/x sites/multi sites/mixed sites/deadhome sites/smap sites/styled sites/thirdparty sites/built sites/notzip team dist; }
cleanup(){
...
rc=0
suites=("$@")
[ ${#suites[@]} -eq 0 ] && suites=(mirror-order field-binding git-publish boot-resilience auth-limit approval-gate team-roles team-console multipage-ingest sitemap assets bundle-ingest)
